...
BstNode::BstNode(int _value, int _x, int _y)
    : value(_value), x(_x), y(_y), min(_x), max(_x), left(nullptr), right(nullptr) {}
BstNode::BstNode(int _value, BstNode *_left, BstNode *_right)
    : value(_value), x(0), y(0), min(0), max(0), left(_left), right(_right) {}
BstNode::BstNode(int _value, int _x, int _y, BstNode *_left, BstNode *_right)
    : value(_value), x(_x), y(_y), min(0), max(0), left(_left), right(_right) {}
